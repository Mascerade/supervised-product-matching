...
from src.model_architectures.model_function import create_embeddings, exp_distance
...
def siamese_network(input_shape):
    ...
    # Send the dense layer to a softmax classifier
    distance = Dropout(0.5)(distance)
    prediction = Dense(units=2, activation='softmax', kernel_regularizer=l2(0.0001))(distance)
